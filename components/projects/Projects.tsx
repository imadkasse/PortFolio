        ...
        dataFilter.map((project, index) => {
          return (
            ...
            >
              ...
              <div className="">
                <div className="px-3 text-center flex justify-center items-center absolute w-full h-full bg-black/80 top-0  scale-0  group-hover:scale-100 transition duration-500">
                  <Link
